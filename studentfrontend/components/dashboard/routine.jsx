...
export default function Routine() {
  ...
  return (
    <div className='flex flex-col gap-2 w-11/12 mx-auto'>
        <div className='bg-pale rounded-lg border-l-8 border-primary py-4 px-2'>
            <div className='flex flex-row justify-between'>
                <h3 className='text-accentD font-[Montserrat] font-semibold text-xl mx-4'>Subject Name</h3>
                <div className='flex flex-row bg-white rounded-full px-1 pl-2 mx-4 items-center self-end'>
                <h3 className='text-sm text-secondary mr-1'>20</h3>
            ...
            <h3 className='text-secondary font-normal text-base mx-4'> <span className='font-bold'>Teacher: </span> Teacher Name</h3>
            <h3 className='text-secondary font-normal text-base mx-4'> <span className='font-bold'>Room: </span> 9.5</h3>
        </div>
        ...
        <h3 className='text-md text-secondary text-center m-4' onClick={()=>{setOpen(!open)}}>{open? <span>View Less</span> : <span>View More</span>}</h3>
    </div>
  )
}